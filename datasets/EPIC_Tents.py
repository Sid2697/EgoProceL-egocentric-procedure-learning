"""
This file contains data loader for the EPIC-Tents dataset
"""
...
class EPIC_Tents(torch.utils.data.Dataset):
    """
    EPIC-Tents loader
    """
    def __init__(self, cfg, mode='all', transforms=None):
        ...
        videos_path = self.cfg.TENTS.VIDEOS_DIR
        anns_path = self.cfg.TENTS.ANNS_DIR
