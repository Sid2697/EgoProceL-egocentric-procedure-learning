...
class PC_Disassembly(torch.utils.data.Dataset):
    """
    PC_Assembly loader
    """
    def __init__(self, cfg, mode='all', transforms=None):
        ...
        videos_path = self.cfg.PCDISASSEMBLY.VIDEOS_DIR
        anns_path = self.cfg.PCDISASSEMBLY.ANNS_DIR
    ...
    def __getitem__(self, index):
        ...
        h5_file_path = _extract_frames_h5py(
            video_path,
            self.cfg.PCDISASSEMBLY.FRAMES_DIR
        )
